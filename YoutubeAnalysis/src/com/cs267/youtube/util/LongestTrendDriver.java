...
import com.cs267.youtube.task5.SparkMaxTrend;

public class LongestTrendDriver {
	
public static void main(String[] args) throws Exception {
		
		if (args.length != 2) {
			System.err.println("usage: LongestTrend <input-file> <output-dir> ");
			System.exit(1);
		}
		String inputFile = args[0];
		String outputDir = args[1];

		SparkConf conf = new SparkConf().setAppName("LongestTrend");
		...
		JavaPairRDD<String, Integer> URLCounts = SparkMaxTrend.getMaxTrend(input);
				

		if (URLCounts != null) {

			URLCounts.saveAsTextFile(outputDir + "_longestTrend");
		}
